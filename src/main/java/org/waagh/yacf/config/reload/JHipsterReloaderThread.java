package org.waagh.yacf.config.reload;

import org.waagh.yacf.config.reload.reloader.JacksonReloader;
import org.waagh.yacf.config.reload.reloader.LiquibaseReloader;
import org.waagh.yacf.config.reload.reloader.SpringReloader;
    ...
    public void reloadEvent(String typename, Class<?> clazz) {
        synchronized (lock) {
            ...
            if (AnnotationUtils.findAnnotation(clazz, Repository.class) != null ||
                ...
                startReloading = true;
            } else if (typename.startsWith("org.waagh.yacf.domain")) {
            ...
            } else if (typename.startsWith("org.waagh.yacf.web.rest.dto")) {
